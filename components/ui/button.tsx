...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-all duration-300 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 shrink-0 [&_svg]:shrink-0 outline-none focus-visible:ring-ring/50 focus-visible:ring-[3px] aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive",
  {
    variants: {
      variant: {
        default:
          'bg-brand-primary text-brand-primary-foreground shadow-sm hover:bg-brand-primary/90',
        destructive:
        ...
        outline:
          'border border-border bg-transparent text-brand-neutral hover:bg-brand-muted/40',
        secondary:
          'bg-brand-secondary text-brand-secondary-foreground shadow-sm hover:bg-brand-secondary/90',
        ghost:
          'bg-transparent text-brand-neutral hover:bg-brand-muted/40',
